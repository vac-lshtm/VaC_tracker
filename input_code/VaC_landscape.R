...
timeline = timeline %>% 
  ...
  add_row(group = "Sinovac", subgroup = "Inactivated", 
        ...
        start = '01/04/2021', end = '31/03/2025', stage = "Phase IV", use="Yes") %>% 
  add_row(group = "University of Oxford<br>AstraZeneca", subgroup = "Vector (non-replicating)", 
          content = '<b>BNT162/CoronaVac/ChAdOx1-S</b><br>Phase III, Hong Kong <i>(Not yet recruiting)</i><br><a href="https://clinicaltrials.gov/ct2/show/NCT04800133" style="color:#006d2c" target="_blank">NCT04800133</a>', 
          start = '01/04/2021', end = '31/03/2025', stage = "Phase IV", use="Yes") %>% 
  ...
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>mRNA-1273/BNT162</b><br>Phase III, Switzerland <i>(Active, not recruiting)</i><br><a href="https://clinicaltrials.gov/ct2/show/NCT04805125" style="color:#006d2c" target="_blank">NCT04805125</a>', 
          start = '19/04/2021', end = '31/07/2022', stage = "Phase IV", use="Yes") %>% 

  # add timeline input for phase III NCT04864561
  add_row(group = "University of Oxford<br>AstraZeneca", subgroup = "Vector (non-replicating)", 
          content = '<b>VLA2001/ChAdOx1-S</b><br>Phase III, UK <i>(Active, not recruiting)</i><br><a href="https://clinicaltrials.gov/ct2/show/NCT04864561" style="color:#006d2c" target="_blank">NCT04864561</a>', 
  ...
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>BNT162 (b2)/mRNA-1273</b><br>Phase IV, Belgium <i>(Ongoing)</i><br><a href="https://www.clinicaltrialsregister.eu/ctr-search/trial/2021-000893-27/BE" style="color:#006d2c" target="_blank">EUCTR2021-000893-27-BE</a>', 
  ...
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>mRNA-1273/BNT162 (b2)</b><br>Phase IV, Netherlands <i>(Pending)</i><br><a href="https://www.clinicaltrialsregister.eu/ctr-search/trial/2021-003388-90/NL" style="color:#006d2c" target="_blank">EUCTR2021-003388-90-NL</a>', 
  ...
  # add timeline input for NCT04889209
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>BNT162 (b2)/mRNA-1273</b><br>Phase IV, Norway <i>(Ongoing)</i><br><a https://www.clinicaltrialsregister.eu/ctr-search/trial/2021-003618-37/NO" style="color:#006d2c" target="_blank">EUCTR2021-003618-37-NO</a>', 
          start = '29/06/2021', end = '29/09/2023', stage = "Phase IV", use="Yes") %>% 
  
  # add timeline input for NCT04969250
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>BNT162 (b2)/mRNA-1273</b><br>Phase IV, Pending <i>(Not yet recruiting)</i><br><a https://clinicaltrials.gov/ct2/show/NCT04969250" style="color:#006d2c" target="_blank">NCT04969250</a>', 
          start = '01/07/2021', end = '31/07/2022', stage = "Phase IV", use="Yes") %>% 
  
  # add timeline input for NCT04969263
  add_row(group = "Moderna<br>NIAID", subgroup = "RNA", 
          content = '<b>BNT162 (b2)/mRNA-1273</b><br>Phase II, USA <i>(Not yet recruiting)</i><br><a https://clinicaltrials.gov/ct2/show/NCT04969263" style="color:#006d2c" target="_blank">NCT04969263</a>', 
          start = '01/08/2021', end = '31/10/2021', stage = "Phase IV", use="Yes") %>% 
  ...
  # add timeline input for NCT04979949
  add_row(group = "Sinovac", subgroup = "Inactivated", 
          content = '<b>ERUCOV-VAC/CoronaVac</b><br>Phase II, Turkey <i>(Recruiting)</i><br><a href="https://clinicaltrials.gov/ct2/show/NCT04979949" style="color:#006d2c" target="_blank">NCT04979949</a>', 
          start = '26/07/2021', end = '01/10/2021', stage = "Phase IV", use="Yes")
